...
import bg_top from "../images/bg-footer-top-desktop.svg";
  ...
  render() {
    return (
      <div className={style.footer_section}>
        <img className={style.footer_top} src={bg_top} alt="" />
        <div className={style.footer_main}>
            ...
            <svg width="240" height="39" xmlns="http://www.w3.org/2000/svg">
              <g fill-rule="nonzero" fill="none">
                ...
                <path
                  ...
                  fill="white" //had to put the svg file to change the logo color in white
                />
              </g>
            </svg>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris
              nulla quam, hendrerit licinia vestibulum a, ultrices quis sem.
            </p>
          ...
          <div className={style.footer_newsletter}>
            ...
            <form className={style.footer_form} onSubmit={this.handleSubmit}>
              <div className={style.form_input}>
                <input
                  type="text" //if set type="email" it doesn't work!
                  name="email"
        ...
        <div className={style.footer_socials}>
          <ImFacebook2 size={33} className={style.icon} />
          <SiInstagram size={33} className={style.icon} />
          <FaTwitterSquare size={34} className={style.icon} />
        </div>
      </div>
    );
  }
